...
<reference>
@/home/jan/dev/backmail/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/jan/dev/backmail/.claude/get-shit-done/references/user-profiling.md` to load:
