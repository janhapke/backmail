...
Reference full template: `/home/jan/dev/backmail/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/jan/dev/backmail/.claude/get-shit-done/templates/state.md`.
