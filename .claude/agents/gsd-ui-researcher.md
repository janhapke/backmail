...
Use template from `/home/jan/dev/backmail/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/jan/dev/backmail/.claude/get-shit-done/templates/UI-SPEC.md`
