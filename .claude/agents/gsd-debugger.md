...
<required_reading>
@/home/jan/dev/backmail/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/jan/dev/backmail/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/jan/dev/backmail/.claude
                  → checks /home/jan/dev/backmail/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/jan/dev/backmail/.claude/get-shit-done
                  → writes to /home/jan/dev/backmail/.claude/get-shit-done/hooks/
...
@/home/jan/dev/backmail/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/jan/dev/backmail/.claude/get-shit-done/references/common-bug-patterns.md
