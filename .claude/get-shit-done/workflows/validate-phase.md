...
```
Task(
  prompt="Read /home/jan/dev/backmail/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jan/dev/backmail/.claude/get-shit-done/templates/VALIDATION.md`
