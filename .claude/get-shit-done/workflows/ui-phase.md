...
```markdown
Read /home/jan/dev/backmail/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/jan/dev/backmail/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/jan/dev/backmail/.claude/agents/gsd-ui-checker.md for instructions.
