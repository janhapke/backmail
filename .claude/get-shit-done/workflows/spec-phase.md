...
```bash
INIT=$(node "/home/jan/dev/backmail/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/jan/dev/backmail/.claude/get-shit-done/templates/spec.md.
